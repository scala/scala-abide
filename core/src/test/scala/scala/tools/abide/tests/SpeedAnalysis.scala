...
class SpeedAnalysis extends FunSuite with CompilerProvider with TreeProvider {
  ...
  class ValInsteadOfVar(val traverser : FastTraversal) extends ExistentialRule {
